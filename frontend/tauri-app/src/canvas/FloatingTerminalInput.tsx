...
export const FloatingTerminalInput: React.FC<FloatingTerminalInputProps> = ({
	...
	const getInputPosition = useCallback(() => {
		...
		const top =
			terminalPadding +
			24 +
			(cursorPosition.line - scrollOffset) * charDimensions.height; // +24 for status line
	...
	console.log(
		"FloatingTerminalInput - cursorPosition:",
		cursorPosition,
		"position:",
		position,
		"isConnected:",
		...
		<>
			...
			>
				...
				<div
					...
					title={
						inputMode === "interactive" ? "Interactive Mode" : "Shell Mode"
					}
				/>
