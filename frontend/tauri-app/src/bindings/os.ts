...
export function isLocalSession(session: OsSession): session is { Local: string } {
    return "Local" in session;
}

export function isWslSession(session: OsSession): session is { Wsl: WslSession } {
